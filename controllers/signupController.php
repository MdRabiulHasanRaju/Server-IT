          ...
          if (mysqli_stmt_execute($stmt)) {
            ...
            $body = '
                    ...
                    <head>
                      ...
                      <meta name="title" content="Verification Code - Server IT Studio">
                      <title>Verification Code - Server IT Studio</title>
                      <style>
                        img {
                        width: 140px;
                        margin-top: 15px;
                    ...
                    <body>
                      <div class="container">
                        <div class="content-box">
                          <div class="header">
                            <img src="' . LINK . 'public/images/header-logo.png" alt="LOGO - Server IT Studiio">
                          </div>
                          ...
                          <p>The link provided in this email starts with https:// and contain serveritstudio.com so you know it is from us. To contact customer service you can also simply paste the following link into your browser:</p>
                          <a href="https://www.serveritstudio.com/contact-us" target="_blank">https://www.serveritstudio.com/contact-us</a>
                        </div>
                        <div class="footer-box">
                          <p>Copyright © 2023 Server IT Studio</p>
                        </div>
                      </div>
                    </body>
                    </html>
            ...
            $from = "Server IT Studio <info@serveritstudio.com>";
            $headers = "From: " . $from . "\r\n";
