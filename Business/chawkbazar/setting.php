...
$sql = "select * from user where id= '".$_SESSION['chawkbazar_uid']."' and password='".md5($oldpassword )."'";
$q = $conn->query($sql);
if($q->num_rows>0)
{

$sql = "update user set  password = '".md5($newpassword)."' WHERE id = '".$_SESSION['chawkbazar_uid']."'";
$r = $conn->query($sql);
...
<head>
    ...
    <title>Setting - Server IT Studio</title>
