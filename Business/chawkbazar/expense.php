            ...
            success: function(data) {
                ...
                if (jsonData.success == 1) {
                   // window.location = jsonData.success_msg;
                    ...
                    document.querySelector(".table-sorting .dataTables_filter label input[type='text']").value = jsonData.search_input;
                    document.querySelector(".table-sorting .dataTables_filter label input[type='text']").focus();
                }
            },
