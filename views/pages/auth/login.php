...
$meta_title = "Login - Server IT Studio";
...
<div class="container" style="padding-top:50px;">
    <div class="row">
        <div class="col-12">
            <h3 class="mb-3 title-h3">Login-</h3>
        </div>
    </div>
</div>
<section class="Login-form">
    <form class="s-form" action="<?= LINK; ?>controllers/loginController.php" method="post">
        ...
        <div class="s-inputForm">
            ...
            <input name="password" type="password" id="password" class="s-input" placeholder="Enter your Password">
        ...
        <div class="s-flex-row">
            ...
            <span class="s-span">Forgot password?</span>
        </div>
        <button name="submit" type="submit" class="s-button-submit">Sign In</button>
        <p class="s-p">Don't have an account? <a href="<?= LINK; ?>registration" class="s-span">Sign Up</a>
