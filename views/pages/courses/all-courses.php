    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 all-couses">
                ...
                $courseSql = "SELECT `id`,`cat_id`,`image`,`title`,`sub_title`,`instructor_id`,`price`,`discount_price`,total_students FROM `courses_table` ORDER BY id DESC limit $star_from,$per_page";
