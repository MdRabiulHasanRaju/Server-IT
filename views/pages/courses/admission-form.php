...
<section class="admission-form">
    <div class="container">
        <div class="row">
            <div class="modal fade" id="admissionForm" tabindex="-1">
                        ...
                        <div class="modal-body">
                            <form id="formID" action="" method="post">
                                <div class="form-group admission-input">
                                    ...
                                    <input name="name" value="<?= (isset($_SESSION['name'])) ? $_SESSION['name'] : ''; ?>" type="text" id="name" class="form-control" required>
                                    <span style="color:red;" id="admission_name"></span>
                                </div>
                                <div class="form-group admission-input">
                                    <label for="mobile">Phone Number <span style="color:red;">*</span></label>
                                    <input name="mobile" value="<?= (isset($_SESSION['mobile'])) ? $_SESSION['mobile'] : ''; ?>" type="text" id="mobile" class="form-control" required>
